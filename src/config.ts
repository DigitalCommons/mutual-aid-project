...
import type { ConfigData } from  "sea-map/app/model/config-schema";
import type {
  Initiative, SseInitiative, CustomPropDef, InitiativeObj
} from "mykomap/app/model/data-services";
import { getAddress, getEmail, getTwitter } from "mykomap/app/view/map/default-popup";
...
export const combinedConfig = { ...config, ...versions, aboutHtml: about } as ConfigData;
